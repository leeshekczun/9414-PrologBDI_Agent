...
% ignore picked() observations.
update_beliefs(_, Beliefs, Beliefs).


% update_intentions(+Observation, +Intentions, -Intentions1).
%   Update intentions based on Observations. Remove the goal once the truffle has
%   been picked. Assuming its still the last goal to have been reached.
